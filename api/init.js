...
export default async function handler(request, response) {
  try {
    ...
    if (users.rows[0].count == 0) {
      ...
      await sql`
        INSERT INTO users (id, name, phone, password, territory) 
        VALUES ('REP-1', 'Rajesh Kumar', '9876543210', ${hashedPw}, 'Guntur, AP')
      `;
      ...
      await sql`
        ...
        VALUES ('VISIT-1', 'REP-1', 'farmer', 'Venkat Rao', 'Amaravathi Village', 'High', 95, 'Pest risk up 30%, Rainfall spike', null, 'Cotton (45 days)', ${nextBestAction1}::jsonb, 'pending', 16.5745, 80.3556, '14 days')
      `;
      ...
      await sql`
        INSERT INTO visits (id, repId, type, name, location, priority, priorityScore, reason, inventoryStatus, crop, nextBestAction, status, lat, lng, lastVisit)
        VALUES ('VISIT-2', 'REP-1', 'retailer', 'Kisan Seva Kendra', 'Tenali Market', 'Medium', 82, 'Competitor promo active', 'Low on Insecticides', null, ${nextBestAction2}::jsonb, 'pending', 16.2341, 80.6432, '7 days')
      `;
    }
